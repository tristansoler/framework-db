...
class StagingToBusiness():
    ...
    def __init__(self):
        ...
        self.__source_tables = self.__config.processes.staging_to_business.source_tables
        self.__target_tables = self.__config.processes.staging_to_business.target_tables
